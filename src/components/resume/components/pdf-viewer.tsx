// Credit goes to : https://www.extend.ai/ui/docs/components/pdf-viewer
"use client";
...
import { loadSharedPdfEngine } from "@/components/resume/lib/pdf-thumbnail-utils";
...
function PDFViewerInner({
  ...
  const thumbnailSidebarVisible =
    showThumbnailToggle && sidebarOpen && !isLoading;
              ...
              <TooltipProvider>
                <ToolbarTooltip label="Toggle thumbnails">
                  <Button
                    ...
                    aria-pressed={thumbnailSidebarVisible}
                    disabled={controlsDisabled}
