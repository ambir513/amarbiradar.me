      ...
      >
        <HoverCardTrigger asChild>
          <div
            ...
            className="flex max-h-[50dvh] cursor-pointer flex-col gap-3 overflow-hidden py-3 pl-6 opacity-100 transition-opacity duration-200 data-popup-open:opacity-0"
          >
            {items.map((item) => (
              <div
                key={item.url}
